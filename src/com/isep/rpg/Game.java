                    ...
                    if (goodOne.getHealthPoint() <= 0) {
                        ...
                        // Sinon : riposte d'un des héros
                            ...
                            switch (choice){
                                ...
                                case 2:
                                    Food lemba = new Food("lemba",2);
                                    displayMessage("Le héros " + goodOne + " mange du lemba... Il récupère 2 hp !");
                                    goodOne.winLife(lemba.getPointLife());
                                    break;
    ...
    public static void recompense(List<Hero> heros){
        ...
        while(!tmp) {
            try {
                ...
                while (choiceRecompense > 4 || choiceRecompense <= 0) {
